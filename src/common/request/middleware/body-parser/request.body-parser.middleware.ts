...
export class RequestUrlencodedBodyParserMiddleware implements NestMiddleware {
  ...
  constructor(private readonly configService: ConfigService) {
    this.maxFile = this.configService.get<number>('request.body.urlencoded.maxFileSize');
  }
...
export class RequestJsonBodyParserMiddleware implements NestMiddleware {
  ...
  constructor(private readonly configService: ConfigService) {
    this.maxFile = this.configService.get<number>('request.body.json.maxFileSize');
  }
...
export class RequestRawBodyParserMiddleware implements NestMiddleware {
  ...
  constructor(private readonly configService: ConfigService) {
    this.maxFile = this.configService.get<number>('request.body.raw.maxFileSize');
  }
...
export class RequestTextBodyParserMiddleware implements NestMiddleware {
  ...
  constructor(private readonly configService: ConfigService) {
    this.maxFile = this.configService.get<number>('request.body.text.maxFileSize');
  }
