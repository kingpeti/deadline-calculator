...
export class RequestVersionMiddleware implements NestMiddleware {
  ...
  constructor(private readonly configService: ConfigService) {
    this.versioningGlobalPrefix = this.configService.get<string>('app.globalPrefix');
    this.versioningEnable = this.configService.get<boolean>('app.versioning.enable');
    this.versioningPrefix = this.configService.get<string>('app.versioning.prefix');
    this.versioningVersion = this.configService.get<string>('app.versioning.version');
