...
export class DebuggerOptionService implements IDebuggerOptionService {
  ...
  createLogger(): LoggerOptions {
    const writeIntoFile = this.configService.get<boolean>('debugger.system.writeIntoFile');
    const writeIntoConsole = this.configService.get<boolean>('debugger.system.writeIntoConsole');
