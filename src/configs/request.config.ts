...
import { seconds, customMs } from 'src/common/helper/constants/helper.function.constant';
...
export default registerAs(
  ...
  (): Record<string, any> => ({
    ...
    timestamp: {
      toleranceTimeInMs: customMs('5m'), // 5 mins
    },
    timeout: customMs('30s'), // 30s based on ms module
    userAgent: {
